        ...
        if (resolved) {
            try {
                ...
                if (!libPackageJson.main) {
                    ...
                    main = path_1.resolve(path_1.dirname(resolved), decentralandLibrary.main || libPackageJson.main);
                ...
                if (!libPackageJson.typings) {
                    ...
                    typings = path_1.resolve(path_1.dirname(resolved), decentralandLibrary.typings || libPackageJson.typings);
